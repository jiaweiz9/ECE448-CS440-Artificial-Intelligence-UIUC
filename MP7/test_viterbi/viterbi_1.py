...
epsilon_for_pt = 1e-5
alpha = 5   # exact setting seems to have little or no effect
...
def training(sentences):
    ...
    # print("init prob:", sum(init_prob.values()))
    # print("emit prob:", sum(emit_prob['DET'].values()))
    # print("trans prob", sum(trans_prob['DET'].values()))
    init_prob = trans_prob['START']
...
def viterbi_1(train, test, get_probs=training):
    ...
    for sen in range(len(test)):
        ...
        predicts = predict_tag_seq[max_key]
        #print(predicts)
    return predicts
